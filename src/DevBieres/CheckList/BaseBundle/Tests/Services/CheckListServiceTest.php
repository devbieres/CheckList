...
class CheckListServiceTest extends BaseTestCase {
    ...
    */
	...
	public function testFindAllByParentId() {
			...
			$this->assertEquals(0, count($srv->findAllByParent(null)));
			...
			// Create a first skeleton
			$ck1 = $srv->getNew();
			$ck1->setOwner($user); $ck1->setLabel("1"); $ck1->setDescription("Desc"); $ck1->setSkeleton($s1);
			$srv->save($ck1);
